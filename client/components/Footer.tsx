        ...
        <div className="flex flex-col items-center gap-1.5 mb-6 sm:mb-8 md:mb-12 lg:mb-16">
          ...
          <div className="w-full flex justify-center">
            ...
            <div className="flex flex-col items-center gap-1.5 md:hidden">
              <svg width="65" height="50" viewBox="0 0 65 50" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0">
              ...
              <svg width="295" height="20" viewBox="0 0 295 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex items-center">
