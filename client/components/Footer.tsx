export const Footer = () => {
  return (
    <footer className="bg-coral-primary relative">
      <div className="w-full max-w-[1416px] mx-auto px-4 sm:px-8 lg:px-12 py-8 sm:py-12 lg:py-16">
        ...
        <div className="flex justify-center mb-8 sm:mb-12 lg:mb-16">
          <div className="w-full max-w-[1414px] flex justify-center">
            <svg 
              ...
              className="w-full max-w-xs sm:max-w-md lg:max-w-4xl h-auto"
            >
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center mb-6 sm:mb-8 lg:mb-12 gap-6 lg:gap-0">
