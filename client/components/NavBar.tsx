      ...
      <div className="container mx-auto px-4 sm:px-8 md:px-4 lg:px-8 xl:px-12 py-6 sm:py-6 md:py-4 lg:py-4">
        <div className="flex flex-col md:flex-col lg:flex-row justify-between items-center gap-6 md:gap-6 lg:gap-6">
          ...
          <div className="flex items-center justify-center lg:justify-start">
            <a href="/" className="block">
              <svg
                ...
                className="w-[343px] sm:w-64 md:w-[680px] lg:w-80 xl:w-96 h-auto"
                aria-label="La Curaduría Logo"
              >
                <path d="M40.2922 13.4045H16.2308C14.6823 13.4045 13.4297 14.6579 13.4297 16.2003V26.8089H24.2093C25.676 26.8089 26.8625 27.9964 26.8625 29.4572V40.2166H13.4328C6.01142 40.2166 0 34.2164 0 26.8121V13.4076C0 6.00013 6.01456 0 13.4297 0H40.2922C47.7073 0 53.7219 6.00327 53.7219 13.4045H40.2891H40.2922ZM53.6653 13.4359H53.7251V26.8404C46.3099 26.8404 40.2954 32.8436 40.2954 40.2448H26.8342C26.8342 25.4393 38.835 13.461 53.6684 13.4327L53.6653 13.4359Z" fill="#FF736C"/>
                <path d="M52.8343 46.625C56.8479 46.625 60.1015 43.3775 60.1015 39.3715C60.1015 35.3654 56.8479 32.1179 52.8343 32.1179C48.8208 32.1179 45.5671 35.3654 45.5671 39.3715C45.5671 43.3775 48.8208 46.625 52.8343 46.625Z" fill="#FF736C"/>
                <path d="M81.6135 22.1501H66.991V0.26062H74.3022V14.8557H96.236C96.236 18.8861 92.9628 22.1532 88.9248 22.1532H81.6135V22.1501Z" fill="#FFFFF6"/>
                <path d="M119.907 0.26058H127.218V22.1532H119.907V14.8557C119.907 18.8861 116.634 22.1532 112.596 22.1532H97.9734V14.8557C97.9734 6.7759 104.536 0.244873 112.612 0.244873H119.923L119.907 0.263722V0.26058ZM119.926 14.8557V7.55812H112.615C108.577 7.55812 105.304 10.8252 105.304 14.8557H119.926Z" fill="#FFFFF6"/>
                <path d="M81.6229 39.0667H96.236V46.361H81.6229C73.5469 46.361 66.991 39.8206 66.991 31.7566C66.991 27.7198 70.2673 24.4622 74.2991 24.4622H96.2203C96.2203 28.4989 92.9439 31.7566 88.9122 31.7566H74.2991L74.3148 31.7723C74.3148 35.809 77.5912 39.0667 81.6229 39.0667Z" fill="#FFFFF6"/>
                <path d="M97.9766 31.766V24.4685H105.288V31.766C105.288 35.7965 108.561 39.0636 112.599 39.0636H119.91V24.4685H127.222V46.3611H112.599L112.618 46.38C104.542 46.38 97.9797 39.8489 97.9797 31.7692L97.9766 31.766Z" fill="#FFFFF6"/>
                <path d="M136.298 24.481H150.912C154.956 24.481 158.22 27.7513 158.22 31.7754C158.22 35.7996 154.943 39.0698 150.912 39.0698H143.603C139.559 39.0698 136.295 42.3401 136.295 46.3642H128.987C128.987 38.3033 135.54 31.7597 143.619 31.7597H129.006V24.4653L128.99 24.481H136.298ZM158.232 46.3768H150.924V39.0824C154.968 39.0824 158.232 42.3526 158.232 46.3768Z" fill="#FFFFF6"/>
                <path d="M181.907 24.4685H189.218V46.3611H181.907V39.0635C181.907 43.094 178.633 46.3611 174.595 46.3611H159.973V39.0635C159.973 30.9838 166.535 24.4528 174.611 24.4528H181.922L181.907 24.4716V24.4685ZM181.922 39.0635V31.766H174.611C170.573 31.766 167.3 35.0331 167.3 39.0635H181.922Z" fill="#FFFFF6"/>
                <path d="M198.27 24.4653H205.578C213.657 24.4653 220.21 31.0026 220.21 39.0698C220.21 43.1097 216.933 46.3642 212.902 46.3642H190.977V24.481L190.961 24.4653H198.27ZM198.282 31.7597V39.0541H212.895C212.895 35.0142 209.622 31.7597 205.587 31.7597H198.279H198.282Z" fill="#FFFFF6"/>
                <path d="M220.776 31.766V24.4685H228.087V31.766C228.087 35.7965 231.361 39.0636 235.399 39.0636H242.71V24.4685H250.021V46.3611H235.399L235.418 46.38C227.341 46.38 220.779 39.8489 220.779 31.7692L220.776 31.766Z" fill="#FFFFF6"/>
                <path d="M259.067 24.481H273.68C277.724 24.481 280.988 27.7513 280.988 31.7754C280.988 35.7996 277.711 39.0698 273.68 39.0698H266.372C262.327 39.0698 259.063 42.3401 259.063 46.3642H251.755C251.755 38.3033 258.308 31.7597 266.387 31.7597H251.774V24.4653L251.759 24.481H259.067ZM281.004 46.3768H273.695V39.0824C277.74 39.0824 281.004 42.3526 281.004 46.3768Z" fill="#FFFFF6"/>
                <path d="M290.081 46.3611H282.772V39.0667H297.386V31.7723H290.077C286.046 31.7723 282.769 28.5178 282.769 24.4779H304.706V39.0636H312.014V46.358H290.077L290.081 46.3611Z" fill="#FFFFF6"/>
                <path d="M335.689 24.4685H343V46.3611H335.689V39.0635C335.689 43.094 332.415 46.3611 328.377 46.3611H313.755V39.0635C313.755 30.9838 320.317 24.4528 328.393 24.4528H335.704L335.689 24.4716V24.4685ZM335.707 39.0635V31.766H328.396C324.358 31.766 321.085 35.0331 321.085 39.0635H335.707Z" fill="#FFFFF6"/>
          ...
          <div className="flex flex-col items-center gap-3 w-full lg:flex-row lg:gap-8 lg:w-auto lg:justify-between">
            ...
            <button
              className="bg-coral-primary hover:bg-coral-secondary focus:bg-coral-secondary transition-all duration-200 rounded-xl md:rounded-lg px-2 sm:px-4 md:px-2 lg:px-5 py-1 sm:py-2 md:py-1 lg:py-1.5 flex items-center justify-between gap-2 group focus:outline-none focus:ring-2 focus:ring-coral-primary focus:ring-offset-2 focus:ring-offset-dark-green shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 w-full lg:w-auto"
              aria-label="Publicar un nuevo evento"
            >
              <span className="text-cream text-lg sm:text-sm md:text-lg lg:text-lg font-fraktion font-medium uppercase tracking-wide">
                PUBLICAR EVENTO
              </span>
              <div className="bg-coral-secondary group-hover:bg-coral-dark group-focus:bg-coral-dark transition-colors duration-200 rounded-full p-2 sm:p-2">
                <Calendar className="w-4 h-4 sm:w-4 sm:h-4 md:w-4 md:h-4 lg:w-6 lg:h-6 text-cream" aria-hidden="true" />
              </div>
            </button>
          </div>
        </div>
